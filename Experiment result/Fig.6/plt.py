...
if __name__ == '__main__':
	...
	plt.plot(np.array(data['rate']), np.array(data['A']) , linewidth=1, linestyle='solid',
						  markersize=8,
						  marker='o', mfc='none', mec='b', label='Base A')
	plt.plot(np.array(data['rate']), np.array(data['B']) , color='red', linewidth=1,
	...
	plt.tight_layout()
	foo_fig.savefig('./resolution.eps', format='eps', dpi=1000, bbox_inches='tight')
	plt.show()
